          ...
          <main>
            ...
            <Grid container spacing={5} className={classes.mainGrid}>
              <Grid item xs={12} md={8}>
                ...
                <h3>{room.address}</h3>
                <p>
                  <b>Số phòng ngủ: {room.num_bedrooms}</b>
                </p>
                <p>
                  <b>Số giường: {room.num_beds}</b>
                </p>
                <p>
                  <b>Số phòng tắm: {room.num_bathrooms}</b>
                </p>
              ...
              <Grid item xs={12} md={4}>
                <Paper elevation={0} className={classes.sidebarAboutBox}>
                  <Typography variant="h6" gutterBottom>
                    <h2>Giá tiền</h2>
                    <Button id="btnDatPhong" type="submit">
                      Đặt ngay
                    </Button>
                  </Typography>
                </Paper>
...
export default withStyles(useStyles)(ListBooking);
